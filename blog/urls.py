...
urlpatterns = [
    ...
    path(
        ...
        name='details'),
    path(
        '<slug:category_slug>/<slug:slug>/comment/',
        views.comment,
        name='comment'),
    path(
        '<slug:category_slug>/<slug:slug>/edit_comment/<int:comment_id>/',
        views.edit_comment,
        name='edit_comment'),
    path(
        '<slug:category_slug>/<slug:slug>/delete_comment/<int:comment_id>/',
